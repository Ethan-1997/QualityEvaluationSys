<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 100px;" class="filter-item" :placeholder="tableCol.pkey" v-model="listQuery.pkey">
      </el-input>
    ...
    <el-table  :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      style="width: 100%">
      <el-table-column align="center" :label="tableCol.pno" width="100">
        <template slot-scope="scope">
          <span>{{scope.row.pno}}</span>
        </template>
      </el-table-column>
      <el-table-column width="350px" align="center" :label="tableCol.pkey">
        <template slot-scope="scope">
          <span>{{scope.row.pkey }}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="50px" :label="tableCol.pvalue">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
        ...
        <el-form-item :label="tableCol.pkey" prop="pkey">
          <el-input v-model="temp.pkey"></el-input>
        </el-form-item>
        <el-form-item :label="tableCol.pvalue" prop="pvalue">
          <el-input v-model="temp.pvalue"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import { fetchList, createParameter, updateParameter } from '@/api/parameter'
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const filterVal = ['pno', 'pkey', 'pvalue']
