export function text() {
  ...
  // const items = {
  //   Tid: 'SystemTest-PRO-1',
  //   Tname: '专业能力测试PRO-1',
  //   Tquestion: JSON.stringify(List),
  //   Ttype: '专业'
  // }
  // const items = {
  //   Tid: 'SystemTest-PRO-2',
  //   Tname: '专业能力测试PRO-2',
  //   Tquestion: JSON.stringify(List2),
  //   Ttype: '专业'
  // }
  // const items = {
  //   Tid: 'SystemTest-PRO-3',
  //   Tname: '专业能力测试PRO-3',
  //   Tquestion: JSON.stringify(List3),
  //   Ttype: '专业'
  // }
  // const items = {
  //   Tid: 'SystemTest-PRO-4',
  //   Tname: '专业能力测试PRO-4',
  //   Tquestion: JSON.stringify(List4),
  //   Ttype: '专业'
  // }
  // const items = {
  //   Tid: 'SystemTest-PRO-5',
  //   Tname: '专业能力测试PRO-5',
  //   Tquestion: JSON.stringify(List5),
  //   Ttype: '专业'
  // }
  const items = {
    Tid: 'SystemTest-PRO-6',
    Tname: '专业能力测试PRO-6',
    Tquestion: JSON.stringify(List6),
    Ttype: '专业'
  }
  // const temp = {
  //   items: items,
